<div class="main-content">
	<div class="container-fluid">
		<h3 class="page-title" style="color:  #00008B">Data Kategori Buku</h3>
		<?php
			...
			<div class="col-md-12">
				...
				<div class="panel">
					<div class="panel-body">
								...
								foreach ($kategori as $b) {
									echo '
										<tr>
											...
											<td>
												<a href="#" class="btn btn-warning" data-toggle="modal" data-target="#modal_ubah_kategori" onclick="prepare_ubah_kategori('.$b->id_kategori.')">Ubah</a>
												<a href="#" class="btn btn-danger" data-toggle="modal" data-target="#modal_hapus_kategori" onclick="prepare_hapus_kategori('.$b->id_kategori.')">Hapus</a>
											</td>
										</tr>
									';
									$no++;
						...
						<button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal_tambah_kategori">Tambah Kategori</button>
					</div>
				</div>
				<!-- END TABLE STRIPED -->
			</div>
...
<script type="text/javascript">
	...
	function prepare_ubah_kategori(id)
	{
		...
		$.getJSON('<?php echo base_url(); ?>index.php/kategori/get_data_kategori_by_id/' + id,  function(data){
			...
			$("#ubah_nama").val(data.nama_kategori);
		});
	}
	...
	function prepare_hapus_kategori(id)
	{
		...
		$.getJSON('<?php echo base_url(); ?>index.php/kategori/get_data_kategori_by_id/' + id,  function(data){
			...
			$("#hapus_nama").text(data.nama_kategori);
		});
	}
</script>
