						...
						<div class="content">
							...
							<form class="form-auth-small" action="<?php echo base_url('index.php/login/cek_login'); ?>" method="post">
								<div class="form-group">
									...
									<input type="text" class="form-control" id="signin-email" placeholder="Nama Kasir" name="username">
								</div>
								<div class="form-group">
								...
								<div class="bottom">
									<span class="helper-text"><i class="fa fa-lock"></i> <a href="login/register">daftar</a></span>
								</div>
