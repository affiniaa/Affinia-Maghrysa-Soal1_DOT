...
class Pengguna extends CI_Controller {
	...
	public function tambah()
	{
			...
			$this->form_validation->set_rules('nama_kasir', 'Nama', 'trim|required');
	...
	public function ubah()
	{
		if($this->session->userdata('logged_in') == TRUE){
			...
			$this->form_validation->set_rules('ubah_nama_kasir', 'Nama', 'trim|required');
